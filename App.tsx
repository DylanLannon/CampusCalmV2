    ...
    <SafeAreaProvider>
      <NavigationContainer>
        ...
        >
          ...
          <Tab.Screen name="Finance" component={FinanceScreen} options={{ tabBarIcon: ({ color }) => <Text style={{ fontSize: 22, color }}>💷</Text> }} />
          <Tab.Screen name="Mood" component={MoodScreen} options={{ tabBarIcon: ({ color }) => <Text style={{ fontSize: 22, color }}>💚</Text> }} />
          <Tab.Screen name="Resources" component={ResourcesScreen} options={{ tabBarIcon: ({ color }) => <Text style={{ fontSize: 22, color }}>📚</Text> }} />
